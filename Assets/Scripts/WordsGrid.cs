        ...
        if (currentGameData != null)
        {
            ...
            foreach (var squares in currentGameData.selectedBoardData.Board)
            {
                foreach (var squareLetter in squares.Row)
                {
                    ...
                    {
                        Debug.LogError("All fields in your array should have some letter. Press fill up with random button in your board data to add random letter. Letter: " + squareLetter);
#if UNITY_EDITOR
